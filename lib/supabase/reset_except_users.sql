-- Gyan Setu — RESET SCHEMA (keep users table)
-- WARNING: Drops ALL tables and data except public.users. Run in Supabase SQL editor.
-- After this, run schema.sql to recreate everything else.

-- ============================================================
-- DROP POLICIES (must drop before tables) — skip users table
-- ============================================================
do $$ declare
  r record;
begin
...
-- ============================================================
-- DROP TRIGGERS — skip users table
-- ============================================================
do $$ declare
  r record;
begin
...
-- ============================================================
-- DROP TABLES (cascade handles FK order) — users intentionally omitted
-- ============================================================
...
-- public.users intentionally NOT dropped

-- NOTE: handle_updated_at() is left in place (schema.sql uses `create or replace`)
-- because dropping it with cascade would also drop the users_updated_at trigger
-- we're preserving on public.users.
